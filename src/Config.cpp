...
// gerbil
    ...
    , gerbil_texture_baby_male(mConfig["simulation"]["animal"]["gerbil"]["texture"]["baby male"].toString())
    , gerbil_texture_baby_female(mConfig["simulation"]["animal"]["gerbil"]["texture"]["baby female"].toString())
...
// scorpion
    ...
    , scorpion_baby_texture((mConfig["simulation"]["animal"]["scorpion"]["baby texture"].toString()))
    ...
    ,neuronal_scorpion_time_moving (sf::seconds(mConfig["simulation"]["animal"]["scorpion"]["neuronal time moving"].toDouble()))
    ,neuronal_scorpion_time_idle (sf::seconds(mConfig["simulation"]["animal"]["scorpion"]["neuronal time idle"].toDouble()))
// sensor
