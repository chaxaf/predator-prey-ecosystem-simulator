...
//        const double animal_safe_distance = 1000;
	...
	const std::string gerbil_texture_baby_male; //**
    const std::string gerbil_texture_baby_female; //**
    ...
    const std::string scorpion_baby_texture;
    ...
    const sf::Time neuronal_scorpion_time_moving;
	const sf::Time neuronal_scorpion_time_idle;
